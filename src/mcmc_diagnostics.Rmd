...
# density plot
den_plot <- denplot(data.r2jags, parms = c("beta", "sigma", "phi", "p_fatigue", "p_cognitive_task"))

# trace plot
tra_plot <- traplot(as.mcmc(data.r2jags), parms = c("beta", "sigma", "phi", "p_fatigue", "p_cognitive_task"))
