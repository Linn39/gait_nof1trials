...
analyses <- list(
  ...
  "cauchy_conjugate_left_foot_downsample_5"
  )
# print(file.path(".", "data", "processed", analyses[[n]], "data_r2jags_AR1_stride_lengths_sub_01.RData"))
...
# traceplot(data.r2jags, col = c("beta", "sigma", "phi"), xlab="Iterations")
```
```{r}
