...
analyses <- list(
  ...
  "jags_output_downsample_10"  # with downsampled stride-by-stride data
  )
data.r2jags <- get(load(file.path("..", "data", "processed", analyses[[n]], "data_r2jags_AR1_stride_lengths_sub_02.RData")))   # 
```
