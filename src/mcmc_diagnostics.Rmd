...
data.r2jags <- get(load(file.path("..", "data", "processed", experiment, 
                                  paste0("data_r2jags_AR1_model_diff_prob_", var, "_", sub, ".RData"))))

# Print posterior estimates
print(data.r2jags$BUGSoutput$summary)

# density plot
denplot(data.r2jags, parms = c("beta", "sigma", "phi", "p1"))

# trace plot
traplot(as.mcmc(data.r2jags), parms = c("beta", "sigma", "phi", "p1"))
