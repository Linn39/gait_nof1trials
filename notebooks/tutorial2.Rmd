...
writeLines(modelString, con = "fact_anovaModel_default.txt")
```
...
for (subject in sub_list) {
  for (feature in features_list) {
    ...
    # run jags
    data.r2jags <- run_jags(dat_df, "fact_anovaModel_sigma1000.txt")
...
write.csv(
  all_estimate_df, 
  file = file.path("..", "data", "processed", "all_estimates_cadence_sigma1000.csv"), 
  row.names=FALSE
)
