...
writeLines(modelString, con = "fact_anovaModel_speed.txt")
```
...
for (subject in sub_list) {
  for (feature in features_list) {
    ...
    # run jags
    data.r2jags <- run_jags(dat_df, "fact_anovaModel_speed.txt")
...
write.csv(
  all_estimate_df, 
  file = file.path("..", "data", "processed", "all_estimates_speed_prior.csv"), 
  row.names=FALSE
)
